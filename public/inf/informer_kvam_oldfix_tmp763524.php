<?php
  ...
  // Значит еще не обсчитывалось, следовательно, БУДЕМ СЧИТАТЬ СЕЙЧАС!
    ...
    $query="SELECT * FROM sell_kmn WHERE
              status='0' AND date_upped>='".($oldata-60*60*24*$days)."' AND geo_gorod_id='1' AND price<='2000'
    ...
    $query="SELECT * FROM sell_kva WHERE
              status='0' AND kva_rooms='1' AND date_upped>='".($oldata-60*60*24*$days)."' AND geo_gorod_id='1' AND price<='3000'
            ORDER BY date_upped DESC;";
    $res=mysql_query($query,$db); 
    $kolvo=mysql_num_rows($res);
    ...
    // ================================== 2 комн. кв. ===================
    $query="SELECT * FROM sell_kva WHERE
              status='0' AND kva_rooms='2' AND date_upped>='".($oldata-60*60*24*$days)."' AND geo_gorod_id='1' AND price<='4000'
            ORDER BY date_upped DESC;";
    $res=mysql_query($query,$db); 
    $kolvo=mysql_num_rows($res);
    ...
    // ================================== 3 комн. кв. ===================
    $query="SELECT * FROM sell_kva WHERE
              status='0' AND kva_rooms='3' AND date_upped>='".($oldata-60*60*24*$days)."' AND geo_gorod_id='1' AND price<='5000'
            ORDER BY date_upped DESC;";
    $res=mysql_query($query,$db); 
    $kolvo=mysql_num_rows($res);
    ...
    // ================================== МНОГО комн. кв. ===================
    $query="SELECT * FROM sell_kva WHERE
              status='0' AND kva_rooms>='4' AND date_upped>='".($oldata-60*60*24*$days)."' AND geo_gorod_id='1'
            ORDER BY date_upped DESC;";
    $res=mysql_query($query,$db); 
    $kolvo=mysql_num_rows($res);
    ...
    // ================================== СРЕДНЕЕ по кв. ===================
    $query="SELECT * FROM sell_kva WHERE
              status='0' AND date_upped>='".($oldata-60*60*24*$days)."' AND geo_gorod_id='1'
            ORDER BY date_upped DESC;";
    $res=mysql_query($query,$db); 
    $kolvo=mysql_num_rows($res);
    ...
    ImageString($img, 2, 138, 168, date("d.m.Y", $oldata), $TextColor); // Дата актуальности
