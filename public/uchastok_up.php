  ...
  if ( (isset($_GET['id'])) && (strlen(($_GET['id']))>0) ) {
    ...
    if (owner_of ('sell_uch',$db , $_SESSION['id'], (int)$_GET['id'])) {
      ...
      // ====================== Условие по времени (начало)
        ...
        // Записываем в журнал
        loging_add_uchrecord ($db, $_SESSION['id'], "402", (int)$_GET['id'], get_uch_obyav_by_id($db,(int)$_GET['id']), get_uch_descr_by_id ($db, (int)$_GET['id']), get_uch_conta_by_id ($db, (int)$_GET['id']) );
