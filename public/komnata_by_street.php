...
<html>
<head>
  <title>Продажа комнат в Великом Новгороде по улицам города - Проект &laquo;Новгородская квартира&raquo; - Недвижимость Великого Новгорода.</title>
  ...
  <div class="content_cover">
    <div class="content_inner">
      ...
      <tr>
        ...
        <h2 style="margin-top:0px;">Продажа комнат по улицам города</h2>
        
        <p>
        На данной странице в удобном виде представлен список объявлений о продаже комнат в Великом Новгороде, опубликованных на сайте проекта &laquo;Новгородская квартира&raquo; за последние 30 дней. Улицы следуют в алфавитном порядке, а комнаты по каждой улице расположены в порядке увеличения стоимости. 
        </p>
        ...
        <?php
            ...
            $query="SELECT t1.id,t2.id AS street_id, t2.title_d 
                    FROM sell_kmn AS t1, spr_geo_street AS t2
                    WHERE     t1.status='0'
            ...
            if ($kv_kolvo>0) {
              ...
              while ($ar=mysql_fetch_assoc($res)) {
                ...
                echo get_kmn_obyav_by_id($db,$ar['id'])." <a href=\"./prodam_komnatu.php?id=".(int)$ar['id']."\" class=\"link\"><img border=\"0\" align=\"absmiddle\" src=\"./pics/ico_arrow.png\" width=\"16\" height=\"16\" title=\"Подробнее\"></a><br>";
