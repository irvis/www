...
<div class="content_box">
  ...
  if ((isset($_GET['sort'])) && ($_GET['sort']=='type'))  { $sort="uch_type ASC, price ASC"; };
  if ((isset($_GET['sort'])) && ($_GET['sort']=='pl'))    { $sort="uch_pl ASC, price ASC"; };
  if ((isset($_GET['sort'])) && ($_GET['sort']=='str'))    { $sort="uch_stroen ASC, price ASC"; };
 ...
 <div class="content_cover">
    <div class="content_inner">
       ...
       <div class="r_date">
           <a href="./uchastok_add.php" class="link"><img width="16" height="16" align="absmiddle" src="./pics/ico_add.png" border="0"></a> 
           <a href="./uchastok_add.php" class="link">Добавить объявление</a>
       </div>
       <div class="clear"></div>
       
       <h2>Купить участок, дачу в Великом Новгороде и Новгородской области</h2>
