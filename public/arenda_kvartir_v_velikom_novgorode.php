...
<html>
<head>
  <title>Снять квартиру в Великом Новгороде - Проект &laquo;Новгородская квартира&raquo; (Недвижимость Великого Новгорода)</title>
...
<div class="content_box">
 ...
 <div class="content_cover">
    <div class="content_inner">
       ...
       <h2>Снять квартиру в Великом Новгороде</h2>
       <?php require "./_parts/adsense_tabl_verx.php";      ?>
	   <div class="clear"></div>
       
       <p style="margin-top:0px;">Смотреть: &nbsp;&nbsp;&nbsp;
         <img width="16" height="16" align="absmiddle" src="./pics/ico_realty.png"> <a href="./arenda_1-komn_kvartir_v_velikom_novgorode.php" class="link">1-комн. квартиры</a>, &nbsp;&nbsp;&nbsp;
         <img width="16" height="16" align="absmiddle" src="./pics/ico_realty.png"> <a href="./arenda_2-komn_kvartir_v_velikom_novgorode.php" class="link">2-комн. квартиры</a>, &nbsp;&nbsp;&nbsp;
         <img width="16" height="16" align="absmiddle" src="./pics/ico_realty.png"> <a href="./arenda_3-komn_kvartir_v_velikom_novgorode.php" class="link">3-комн. квартиры</a>, &nbsp;&nbsp;&nbsp;
         <img width="16" height="16" align="absmiddle" src="./pics/ico_realty.png"> <a href="./arenda_n-komn_kvartir_v_velikom_novgorode.php" class="link">многокомн. квартиры</a>
       </p>
       <div class="clear"></div>
       ...
       <tr class="tr_buy">
         <td align="center" width="75"><a href="./arenda_kvartir_v_velikom_novgorode.php?sort=data" class="blink" title="Сортировать по дате (актуальные сверху)">Дата</a></td>
         <td align="center" width="80"><a href="./arenda_kvartir_v_velikom_novgorode.php?sort=type" class="blink" title="Сортировать по типу квартиры (количеству комнат)">Квартира</a></td>
         <td align="center"><b>Адрес</b></td>
         <td align="center"><span title="Материал"><b>М</b></span></td>
         <td align="center"><a href="./arenda_kvartir_v_velikom_novgorode.php?sort=op" class="blink" title="Сортировать по общей площади (по возр.)">O</a></td>
         <td align="center"><a href="./arenda_kvartir_v_velikom_novgorode.php?sort=zp" class="blink" title="Сортировать по жилой площади (по возр.)">Ж</a></td>
         <td align="center"><a href="./arenda_kvartir_v_velikom_novgorode.php?sort=pk" class="blink" title="Сортировать по площади кухни (по возр.)">К</a></td>
         <td align="center"><a href="./arenda_kvartir_v_velikom_novgorode.php?sort=et" class="blink" title="Сортировать по этажу (по возр.)">Э</a></td>
         <td align="center"><b><span title="Балкон / лоджия">Б</span></b></td>
         <td align="center" width="90"><a href="./arenda_kvartir_v_velikom_novgorode.php?sort=price" class="blink" title="Сортировать по цене (по возр.)">Цена</a></td>
