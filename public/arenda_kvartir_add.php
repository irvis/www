...
<html>
<head>
  <title>Подать объявление о сдаче в аренду квартиры в Великом Новгороде - Проект &laquo;Новгородская квартира&raquo; (Недвижимость Великого Новгорода)</title>
...
if ($glogged==1) { // Пользователь авторизован
  ...
  // Если что-то передано через POST - проверка на вшивость!
    ...
    // Если ошибок нет
      ...
      $query="INSERT INTO rent_kva SET ";
      //$query.="status='0',";
      //$query.="checked_fl='0',";
      ...
      unilog_add_record (
		 ...
		 "Добавление объявления: ".get_kv_rent_obyav_by_id($db,$last_id),   // Описание - генерация текста объявления
      ...
      echo "<b style=\"color:green\">Ваше объявление добавлено!</b> Посмотреть опубликованное объявление можно <a href=\"./sdam_kvartiru.php?id=".$last_id."\" class=\"link\">здесь</a>.<br>"; 
      unset($_POST);
      $showme=false;
...
?>    
       ...
       <h2>Сдать квартиру в Великом Новгороде</h2>
       <div class="clear"></div>
       
       <form name="myform" action="arenda_kvartir_add.php" method="post">
       <!-- ТАБЛИЦА -->
