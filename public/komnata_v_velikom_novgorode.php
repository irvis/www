...
if ((isset($_GET['sort'])) && ($_GET['sort'] == 's')) {
    $sort = "kmn_pl ASC";
}
if ((isset($_GET['sort'])) && ($_GET['sort'] == 'price')) {
    $sort = "price ASC";
}
if ((isset($_GET['sort'])) && ($_GET['sort'] == 'data')) {
    $sort = "date_upped DESC";
}
...
?>       
 ...
 <div class="content_cover">
					<div class="content_inner">
						...
						<div class="r_date">
							<a href="./komnata_add.php" class="link"><img width="16"
								height="16" align="absmiddle" src="./pics/ico_add.png"
								border="0"></a> <a href="./komnata_add.php" class="link">Добавить
								объявление</a>
						</div>

						<h2>Купить комнату в Великом Новгороде</h2>
       <?php require "./_parts/adsense_tabl_verx.php";      ?>
	   <div class="clear"></div>

						<img src="./pics/ico_filter.gif" width="18" height="18"
							align="absmiddle" border="0"> <b>Найдено <?php echo $kolvo; ?> объектов</b>
						...
						<table width="690" cellpadding="5" class="st" cellspacing="0">
							<tr class="tr_buy">
								<td align="center" width="75"><a
									href="./komnata_v_velikom_novgorode.php?sort=data"
									class="blink" title="Сортировать по дате (актуальные сверху)">Дата</a></td>
								<td align="center"><b>Объект</b></td>
								<td align="center"><b>Адрес</b></td>
								<td align="center"><span title="Материал"><b>М</b></span></td>
								<td align="center"><a
									href="./komnata_v_velikom_novgorode.php?sort=s" class="blink"
									title="Сортировать по площади (по возр.)">Пл.</a></td>
								<td align="center"><b><span title="Этаж">Э</span></b></td>
								<td align="center"><b><span title="Балкон / лоджия">Б</span></b></td>
								<td align="center" width="90"><a
									href="./komnata_v_velikom_novgorode.php?sort=price"
									class="blink" title="Сортировать по цене (по возр.)">Цена</a></td>
...
?>
      ...
      <tr <?php echo $class_tr; ?>>
           ...
           <?php if (isset($_SESSION['id']) && $ar['usr_id']==$_SESSION['id']) { ?>
             <br> <a
									href="./komnata_edit.php?id=<?php echo $ar['id']; ?>"
									class="link"><img width="16" height="16" align="absmiddle"
										src="./pics/ico_edit.png" title="Редактировать объявление"
										border="0"></a> <a
									href="./komnata_delete.php?id=<?php echo $ar['id']; ?>"
									class="link" onclick="return confirmDelete();"><img width="16"
										height="16" align="absmiddle" src="./pics/ico_delete.png"
										title="Удалить объявление" border="0"></a> <a
									href="./komnata_up.php?id=<?php echo $ar['id']; ?>"
									class="link"><img width="16" height="16" align="absmiddle"
           ...
           <?php } ?>
								...
								<td align="center" valign="top"><span
									title="<?php echo gettitle($db, 'spr_kmn_type', $ar['kmn_type_id']); ?>"><?php echo gettitle_d($db, 'spr_kmn_type', $ar['kmn_type_id']); ?></span></td>
								...
								<td align="center" valign="top"><?php if ($ar['kmn_balkon']=='1') { ?><img
								...
								<td align="left" valign="middle"><a
									href="./prodam_komnatu.php?id=<?php echo $ar['id']; ?>"
									class="link"><img width="16" height="16" align="absmiddle"
										src="./pics/ico_arrow.png" border="0"></a> <a
									href="./prodam_komnatu.php?id=<?php echo $ar['id']; ?>"
									class="link">Подробнее</a></td>
							</tr>
