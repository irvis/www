...
if (isset($_GET['id'])) {
  $kolvo=0;
  $query="SELECT * FROM sell_kva WHERE status='0' AND id='".(int)($_GET['id'])."'";
  $res = $db->query($query); 
  $kolvo=$res->num_rows;
  if ($kolvo!=0) {
...
// ======================================================================
  // Формируем заголовки
  $super_title="";
  $super_title.="Продам ".$ar[kva_rooms]."-комн. квартиру ";
...
<div class="content_box">
  ...
  <div class="content_cover">
    <div class="content_inner" style="width:700px;">
      ...
      <div class="l_date">
          <a href="./kvartira_v_velikom_novgorode.php" class="link"><img width="16" height="16" align="absmiddle" src="./pics/ico_uplist.png" border="0"></a> 
          <a href="./kvartira_v_velikom_novgorode.php" class="link">Назад к списку</a>
          
          <?php if ($ar['usr_id']==$_SESSION['id']) { ?>
             &nbsp;&nbsp;&nbsp;
            <a href="./kvartira_edit.php?id=<?php echo $ar['id']; ?>" class="link"><img width="16" height="16" align="absmiddle" src="./pics/ico_edit.png"></a> 
            <a href="./kvartira_edit.php?id=<?php echo $ar['id']; ?>" class="link">Редактировать</a>
            &nbsp;&nbsp;&nbsp;
            <a href="./kvartira_delete.php?id=<?php echo $ar['id']; ?>" class="link" onclick="return confirmDelete();"><img width="16" height="16" align="absmiddle" src="./pics/ico_delete.png"></a> 
            <a href="./kvartira_delete.php?id=<?php echo $ar['id']; ?>" class="link" onclick="return confirmDelete();">Удалить</a>
            &nbsp;&nbsp;&nbsp;
            <a href="./kvartira_up.php?id=<?php echo $ar['id']; ?>" class="link"><img width="16" height="16" align="absmiddle" src="./pics/ico_up.png"></a> 
            <a href="./kvartira_up.php?id=<?php echo $ar['id']; ?>" class="link">Поднять</a>
            &nbsp;&nbsp;&nbsp;
...
<?php
         ...
         $obj_type='11';             // Задаем тип: продажа квартиры
