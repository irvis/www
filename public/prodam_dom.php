...
if (isset($_GET['id'])) {
  $kolvo=0;
  $query="SELECT * FROM sell_dom WHERE status='0' AND id='".(int)($_GET['id'])."'";
  $res=$db->query($query); 
  $kolvo=$res->num_rows;
  if ($kolvo!=0) {
...
// ======================================================================
  // Формируем заголовки
  $super_title="";
  $super_title.="Продам ".gettitle($db, 'spr_zd_material', $ar['dom_material_id'])." ".gettitle_d($db, 'spr_dom_type', $ar['dom_type']).", ";
  $super_title.=$ar[dom_pl_ob]." кв. м, ";
...
<div class="content_box">
  ...
  <div class="content_cover">
    <div class="content_inner" style="width:700px;">
      ...
      <div class="l_date">
          <a href="./dom_v_velikom_novgorode.php" class="link"><img width="16" height="16" align="absmiddle" src="./pics/ico_uplist.png" border="0"></a> 
          <a href="./dom_v_velikom_novgorode.php" class="link">Назад к списку</a>
          
          <?php if (isset($_SESSION['id']) && $ar['usr_id']==$_SESSION['id']) { ?>
             &nbsp;&nbsp;&nbsp;
            <a href="./dom_edit.php?id=<?php echo $ar['id']; ?>" class="link"><img width="16" height="16" align="absmiddle" src="./pics/ico_edit.png"></a> 
            <a href="./dom_edit.php?id=<?php echo $ar['id']; ?>" class="link">Редактировать</a>
            &nbsp;&nbsp;&nbsp;
            <a href="./dom_delete.php?id=<?php echo $ar['id']; ?>" class="link" onclick="return confirmDelete();"><img width="16" height="16" align="absmiddle" src="./pics/ico_delete.png"></a> 
            <a href="./dom_delete.php?id=<?php echo $ar['id']; ?>" class="link" onclick="return confirmDelete();">Удалить</a>
            &nbsp;&nbsp;&nbsp;
            <a href="./dom_up.php?id=<?php echo $ar['id']; ?>" class="link"><img width="16" height="16" align="absmiddle" src="./pics/ico_up.png"></a> 
            <a href="./dom_up.php?id=<?php echo $ar['id']; ?>" class="link">Поднять</a>
            &nbsp;&nbsp;&nbsp;
      ...
      <div class="part_left350">
        ...
        echo"Объект: ";
        echo gettitle($db, 'spr_dom_type', $ar['dom_type'])."<br>";
        
        echo"Адрес: ";
        echo $sobr_adres."<br>";
        
        echo"Материал дома: ";
        echo gettitle($db, 'spr_zd_material', $ar['dom_material_id'])."<br>";
        
        echo"Количество этажей: ";
        echo $ar['dom_floors']."<br>";
        
        echo"Общая площадь: ";
        echo $ar['dom_pl_ob']." кв. м<br>";
        
        if ($ar['dom_pl_zh']!=0){ 
          echo"Жилая площадь: ";
          echo $ar['dom_pl_zh']." кв. м<br>";
        }; 
...
<?php
         ...
         $obj_type='51';             // Задаем тип: продажа дома, коттеджа
