...
if (isset($_GET['id'])) {
  $kolvo=0;
  $query="SELECT * FROM sell_uch WHERE status='0' AND id='".(int)($_GET['id'])."'";
  $res=$db->query($query); 
  $kolvo=$res->num_rows;
  if ($kolvo!=0) {
...
// ======================================================================
        ...
        if ( ($ar['geo_gorod_id']>0) || (($ar['geo_gorod_id']==-1) && (strlen($ar['geo_gorod'])!=0)) ){
          ...
          // NEWWWWWWWWWWWWWWWWWW (если указан только нас. пункт, => убрать запятую в конце!!!
            $sobr_adres=substr($sobr_adres,0,strlen($sobr_adres)-2);
          // !!!!!!!!!!
          };
        };
...
// ======================================================================
  // Формируем заголовки
  $super_title="";
  $super_title.="Продам ".gettitle_d($db, 'spr_uch_type', $ar['uch_type']).", ";
  
  if ($ar[uch_pl]<100) {
    $super_title.=$ar[uch_pl]." соток, ";
  } else {
    $super_title.=($ar[uch_pl]/100)." га, ";
  };
...
<div class="content_box">
  ...
  <div class="content_cover">
    <div class="content_inner" style="width:700px;">
      ...
      <div class="l_date">
          <a href="./uchastok_v_velikom_novgorode.php" class="link"><img width="16" height="16" align="absmiddle" src="./pics/ico_uplist.png" border="0"></a> 
          <a href="./uchastok_v_velikom_novgorode.php" class="link">Назад к списку</a>
          
          <?php if (isset($_SESSION['id']) && $ar['usr_id']==$_SESSION['id']) { ?>
             &nbsp;&nbsp;&nbsp;
            <a href="./uchastok_edit.php?id=<?php echo $ar['id']; ?>" class="link"><img width="16" height="16" align="absmiddle" src="./pics/ico_edit.png"></a> 
            <a href="./uchastok_edit.php?id=<?php echo $ar['id']; ?>" class="link">Редактировать</a>
            &nbsp;&nbsp;&nbsp;
            <a href="./uchastok_delete.php?id=<?php echo $ar['id']; ?>" class="link" onclick="return confirmDelete();"><img width="16" height="16" align="absmiddle" src="./pics/ico_delete.png"></a> 
            <a href="./uchastok_delete.php?id=<?php echo $ar['id']; ?>" class="link" onclick="return confirmDelete();">Удалить</a>
            &nbsp;&nbsp;&nbsp;
            <a href="./uchastok_up.php?id=<?php echo $ar['id']; ?>" class="link"><img width="16" height="16" align="absmiddle" src="./pics/ico_up.png"></a> 
            <a href="./uchastok_up.php?id=<?php echo $ar['id']; ?>" class="link">Поднять</a>
            &nbsp;&nbsp;&nbsp;
      ...
      <div class="part_left350">
        ...
        echo"Тип объекта: ";
        echo gettitle($db, 'spr_uch_type', $ar['uch_type'])."<br>";
        ...
        echo"Площадь: ";
        if ($ar[uch_pl]<100) {
          echo $ar['uch_pl']." соток<br>";
        } else {
          echo ($ar[uch_pl]/100)." га<br>";
        };
        
        
        if ($ar[uch_stroen]=='1') {
          echo"Наличие строений на участке: есть<br>";
        };
...
<?php
         ...
         $obj_type='71';             // Задаем тип: продажа участка
