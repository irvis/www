<?php 
  ...
  if ( (isset($_GET['id'])) && (strlen(($_GET['id']))>0) ) {
    ...
    if (owner_of ('sell_kva',$db , $_SESSION['id'], (int)$_GET['id'])) {
      ...
      // Записываем в журнал
      loging_add_kvrecord ($db, $_SESSION['id'], "104", (int)$_GET['id'], get_kv_obyav_by_id($db,(int)$_GET['id']), get_kv_descr_by_id ($db, (int)$_GET['id']), get_kv_conta_by_id ($db, (int)$_GET['id']) );
      ...
      unilog_add_record (
		 ...
		 "Удаление объявления: ".get_kv_obyav_by_id($db,(int)$_GET['id']),   // Описание - генерация текста объявления
