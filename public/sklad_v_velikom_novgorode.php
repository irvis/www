...
<html>
<head>
  <title>Складские помещения в Великом Новгороде (в аренду и на продажу) - Проект &laquo;Новгородская квартира&raquo; (Недвижимость Великого Новгорода)</title>
...
<div class="content_box">
  ...
  <div class="content_header">
        ...
        <b>Аренда и продажа складских помещений в Великом Новгороде</b>
        </div>
  </div>
 ...
 <div class="content_cover">
    <div class="content_inner" style="width:690px;">
       ...
       <div class="clear"></div>
       <h2>Аренда и продажа СКЛАДСКИХ помещений в Великом Новгороде</h2>
       <div class="clear"></div>
       
       <img height="120" width="662" style="display:inline;float:left;margin-right:20px;margin-bottom:20px;border:1px solid #acabab;" alt="Аренда складских помещений в Великом Новгороде" src="./pics/realty/660x120_sklad_005.jpg"/>
