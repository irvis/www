...
<html>
<head>
  <title>Снять комнату в Великом Новгороде - Проект &laquo;Новгородская квартира&raquo; (Недвижимость Великого Новгорода)</title>
...
<div class="content_box">
  ...
  if ((isset($_GET['sort'])) && ($_GET['sort']=='s'))     { $sort="kmn_pl ASC"; };
 ...
 <div class="content_cover">
    <div class="content_inner">
       ...
       <div class="r_date">
           <a href="./arenda_komnat_add.php" class="link"><img width="16" height="16" align="absmiddle" src="./pics/ico_add.png" border="0"></a> 
           <a href="./arenda_komnat_add.php" class="link">Добавить объявление</a>
       </div>
       
       <h2>Снять комнату в Великом Новгороде</h2>
       ...
       <tr class="tr_buy">
         <td align="center" width="75"><a href="./arenda_komnat_v_velikom_novgorode.php?sort=data" class="blink" title="Сортировать по дате (актуальные сверху)">Дата</a></td>
         <td align="center"><b>Объект</b></td>
         <td align="center"><b>Адрес</b></td>
         <td align="center"><span title="Материал"><b>М</b></span></td>
         <td align="center"><a href="./arenda_komnat_v_velikom_novgorode.php?sort=s" class="blink" title="Сортировать по площади (по возр.)">Пл.</a></td>
         <td align="center"><b><span title="Этаж">Э</span></b></td>
         <td align="center"><b><span title="Балкон / лоджия">Б</span></b></td>
         <td align="center" width="90"><a href="./arenda_komnat_v_velikom_novgorode.php?sort=price" class="blink" title="Сортировать по цене (по возр.)">Цена</a></td>
