<?php 
  ...
  if ( (isset($_GET['id'])) && (strlen(($_GET['id']))>0) ) {
    ...
    if (owner_of ('sell_dom',$db , $_SESSION['id'], (int)$_GET['id'])) {
      ...
      // Записываем в журнал
      loging_add_domrecord ($db, $_SESSION['id'], "304", (int)$_GET['id'], get_dom_obyav_by_id($db,(int)$_GET['id']), get_dom_descr_by_id ($db, (int)$_GET['id']), get_dom_conta_by_id ($db, (int)$_GET['id']) );
