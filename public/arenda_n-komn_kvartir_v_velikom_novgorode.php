...
<html>
<head>
  <title>Снять многокомн. квартиру в Великом Новгороде - Проект &laquo;Новгородская квартира&raquo; (Недвижимость Великого Новгорода)</title>
...
<div class="content_box">
 ...
 <div class="content_cover">
    <div class="content_inner">
       ...
       <h2>Снять многокомн. квартиру в Великом Новгороде</h2>
       ...
       <tr class="tr_buy">
         <td align="center" width="75"><a href="./arenda_n-komn_kvartir_v_velikom_novgorode.php?sort=data" class="blink" title="Сортировать по дате (актуальные сверху)">Дата</a></td>
         <td align="center" width="80"><b>Квартира</b></td>
         <td align="center"><b>Адрес</b></td>
         <td align="center"><span title="Материал"><b>М</b></span></td>
         <td align="center"><a href="./arenda_n-komn_kvartir_v_velikom_novgorode.php?sort=op" class="blink" title="Сортировать по общей площади (по возр.)">O</a></td>
         <td align="center"><a href="./arenda_n-komn_kvartir_v_velikom_novgorode.php?sort=zp" class="blink" title="Сортировать по жилой площади (по возр.)">Ж</a></td>
         <td align="center"><a href="./arenda_n-komn_kvartir_v_velikom_novgorode.php?sort=pk" class="blink" title="Сортировать по площади кухни (по возр.)">К</a></td>
         <td align="center"><a href="./arenda_n-komn_kvartir_v_velikom_novgorode.php?sort=et" class="blink" title="Сортировать по этажу (по возр.)">Э</a></td>
         <td align="center"><b><span title="Балкон / лоджия">Б</span></b></td>
         <td align="center" width="90"><a href="./arenda_n-komn_kvartir_v_velikom_novgorode.php?sort=price" class="blink" title="Сортировать по цене (по возр.)">Цена</a></td>
