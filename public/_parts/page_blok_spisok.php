<div class="content_box">
  ...
  <div class="content_header">
        ...
        <b>Недвижимость Великого Новгорода</b>
        </div>
  </div>
 ...
 <div class="content_cover">
    <div class="content_inner">
       ...
       <tr style="background-color: #55BD3F;color:#ffffff;">
...
//echo "</pre>";
      ...
      // Продам комнату
      $sobr_note.=gettitle_d($db, 'spr_obj_type', $ar['obj_type_id']).", ";
      ...
      if ($ar['obj_price_sell']!=0) {
        ...
        if ($ar['obj_price_torg']!=0) { // возможен торг
          $sobr_price.=", ".gettitle_d($db, 'spr_obj_price_torg', $ar['obj_price_torg']);
        };
      } else {
      ...
      echo "<td align=\"center\" valign=\"top\"><a href=\"./view_realty.php?id=".$ar['id']."\" class=\"link\" title=\"Откроется в новом окне\" target=\"_blank\">Подробнее</a></td>";
      echo "</tr>";
