...
if (isset($_GET['id'])) {
  $kolvo=0;
  $query="SELECT * FROM rent_kmn WHERE status='0' AND id='".(int)($_GET['id'])."'";
  $res=$db->query($query); 
  $kolvo=$res->num_rows;
  if ($kolvo!=0) {
...
<div class="content_box">
  ...
  <div class="content_cover">
    <div class="content_inner" style="width:700px;">
      ...
      <div class="l_date">
          <a href="./arenda_komnat_v_velikom_novgorode.php" class="link"><img width="16" height="16" align="absmiddle" src="./pics/ico_uplist.png" border="0"></a> 
          <a href="./arenda_komnat_v_velikom_novgorode.php" class="link">Назад к списку</a>
          
          <?php if (isset($_SESSION['id']) && $ar['usr_id']==$_SESSION['id']) { ?>
             &nbsp;&nbsp;&nbsp;
            <a href="./arenda_komnat_edit.php?id=<?php echo $ar['id']; ?>" class="link"><img width="16" height="16" align="absmiddle" src="./pics/ico_edit.png"></a> 
            <a href="./arenda_komnat_edit.php?id=<?php echo $ar['id']; ?>" class="link">Редактировать</a>
            &nbsp;&nbsp;&nbsp;
            <a href="./arenda_komnat_delete.php?id=<?php echo $ar['id']; ?>" class="link" onclick="return confirmDelete();"><img width="16" height="16" align="absmiddle" src="./pics/ico_delete.png"></a> 
            <a href="./arenda_komnat_delete.php?id=<?php echo $ar['id']; ?>" class="link" onclick="return confirmDelete();">Удалить</a>
            &nbsp;&nbsp;&nbsp;
            <a href="./arenda_komnat_up.php?id=<?php echo $ar['id']; ?>" class="link"><img width="16" height="16" align="absmiddle" src="./pics/ico_up.png"></a> 
            <a href="./arenda_komnat_up.php?id=<?php echo $ar['id']; ?>" class="link">Поднять</a>
            &nbsp;&nbsp;&nbsp;
      ...
      <div class="part_left350">
        ...
        if ($ar['zd_material_id']!=0) {
          echo"Материал дома: ";
          echo gettitle($db, 'spr_zd_material', $ar['zd_material_id'])."<br>";
        };
        
        echo"Тип комнаты: ";
        echo gettitle($db, 'spr_kmn_type', $ar['kmn_type_id'])."<br>";
        
        echo"Площадь комнаты: ";
        echo $ar['kmn_pl']." кв. м<br>";
        
        echo"Этаж: ";
        echo $ar['kmn_floor']."/".$ar['zd_floors']."<br>";
...
<?php
         ...
         $obj_type='22';             // Задаем тип: аренда комнаты
