...
<html>
<head>
  <title>Продажа квартир Великого Новгорода по улицам города - Проект &laquo;Новгородская квартира&raquo; - Недвижимость Великого Новгорода.</title>
  ...
  <div class="content_cover">
    <div class="content_inner">
      ...
      <tr>
        ...
        <h2 style="margin-top:0px;">Продажа квартир по улицам города</h2>
        
        <p>
        На данной странице в удобном виде представлен список объявлений о продаже квартир в Великом Новгороде, опубликованных на сайте проекта &laquo;Новгородская квартира&raquo; за последние 30 дней. Улицы следуют в алфавитном порядке, а квартиры по каждой улице расположены в порядке увеличения стоимости. 
        </p>
        ...
        <?php
            ...
            $query="SELECT t1.id,t2.id AS street_id, t2.title_d 
                    ...
                    ORDER BY t2.title ASC, t1.kva_rooms ASC, t1.price ASC
                    ;
                    ";
